        ...
        {education.map((edu) => (
          ...
          >
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              <span className="rounded-full border border-blue-400/30 bg-blue-400/10 px-3 py-1 text-sm text-blue-600 dark:text-blue-400">
                전공 · {edu.major}
              </span>
              {edu.minor && (
                <span className="rounded-full border border-purple-400/30 bg-purple-400/10 px-3 py-1 text-sm text-purple-500">
                  부전공 · {edu.minor}
                </span>
              )}
            </div>
